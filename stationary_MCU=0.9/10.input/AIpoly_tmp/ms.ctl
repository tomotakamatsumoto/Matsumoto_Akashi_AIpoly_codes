...
repRunGen					= 10840		            	/*	- number of generations for each replicate*/
uswitch_A					= 15000		            	/*	- number of generations after which mutation rates switch to "b" type*/
uswitch_B					= 15000		            	/*	- number of generations after which mutation rates switch to "b" type*/
...
SeqNum_a					= 10		                /*	- number of sequences at the start of the simulation. if there is no population fluctuation the population remains at this size*/
...
fitness_u							= 0.9989	            	/*		- fitness of unprefered codon*/
