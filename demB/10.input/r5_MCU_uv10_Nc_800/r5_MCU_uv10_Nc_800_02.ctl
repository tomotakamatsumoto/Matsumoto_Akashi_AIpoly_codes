...
seqLen						= 3000		            	/*	- length of sequences. has to be a multiple of 3*/
...
u01_a							= 1.250	            	/*		- the 0 to 1 mutation rate per site per generation*/
u02_a							= 1.250	            	/*		- the 0 to 2 mutation rate per site per generation*/
u03_a							= 1.250	            	/*		- the 0 to 3 mutation rate per site per generation*/
u10_a							= 1.250	            	/*		- the 1 to 0 mutation rate per site per generation*/
u12_a							= 1.250	            	/*		- the 1 to 2 mutation rate per site per generation*/
u13_a							= 1.250	            	/*		- the 1 to 3 mutation rate per site per generation*/
u20_a							= 1.250	            	/*		- the 2 to 0 mutation rate per site per generation*/
u21_a							= 1.250	            	/*		- the 2 to 1 mutation rate per site per generation*/
u23_a							= 1.250	            	/*		- the 2 to 3 mutation rate per site per generation*/
u30_a							= 1.250	            	/*		- the 3 to 0 mutation rate per site per generation*/
u31_a							= 1.250              	/*		- the 3 to 1 mutation rate per site per generation*/
u32_a							= 1.250	            	/*		- the 3 to 2 mutation rate per site per generation*/
/*	- relative mutation rate after parameter switch */
u01_b							= 1.250	            	/*		- the 0 to 1 mutation rate per site per generation*/
u02_b							= 1.250	            	/*		- the 0 to 2 mutation rate per site per generation*/
u03_b							= 1.250	            	/*		- the 0 to 3 mutation rate per site per generation*/
u10_b							= 1.250	            	/*		- the 1 to 0 mutation rate per site per generation*/
u12_b							= 1.250	            	/*		- the 1 to 2 mutation rate per site per generation*/
u13_b							= 1.250	            	/*		- the 1 to 3 mutation rate per site per generation*/
u20_b							= 1.250	            	/*		- the 2 to 0 mutation rate per site per generation*/
u21_b							= 1.250	            	/*		- the 2 to 1 mutation rate per site per generation*/
u23_b							= 1.250	            	/*		- the 2 to 3 mutation rate per site per generation*/
u30_b							= 1.250	            	/*		- the 3 to 0 mutation rate per site per generation*/
u31_b							= 1.250              	/*		- the 3 to 1 mutation rate per site per generation*/
u32_b							= 1.250	            	/*		- the 3 to 2 mutation rate per site per generation*/

/*	- fitness of each mutation type */
fitness_p							= 1.0000	            	/*		- fitness of preferred codon */
fitness_u							= 0.9983	            	/*		- fitness of unprefered codon*/
