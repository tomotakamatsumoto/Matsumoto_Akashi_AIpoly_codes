...
initRunGen					= 500000		            /*	- number of generations for the initial run*/
preRunGen					= 20000		            	/*	- number of generations for the prerun between replicates*/
repRunGen					= 2000		            	/*	- number of generations for each replicate*/
...
Nes2						= 1.0	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -489834						/*  - initialize random number generator */
