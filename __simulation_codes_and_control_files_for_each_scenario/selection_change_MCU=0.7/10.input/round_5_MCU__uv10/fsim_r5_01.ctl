...
repNum						= 10		                /*	- number of replicates*/
...
initSeqNum					= 10		                /*	- number of sequences at the start of the simulation. if there is no population fluctuation the population remains at this size*/
seqLen						= 1200		            	/*	- length of sequences. has to be a multiple of 3*/
sampleNum					= 10		                /*	- number of sequences to be sampled from the population every replicate*/
c							= 0.01	                	/*	- the recombination rate per site per generation*/
u10							= 0.001	            	/*		- the 1 to 0 mutation rate per site per generation*/
u01							= 0.001	            	/*		- the 0 to 1 mutation rate per site per generation*/
Nes						= 0.0	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -11786						/*  - initialize random number generator */
