...
double cod_w_list_A[64];
double cod_w_list_B[64];
double cod_w_list_C[64];
/*---------------------------------------------------------------------------------------*/
int main(void)
{
...
void CheckAncSite(struct userPref_str *userPrefp)
{
    ...
    if (userPrefp->prerunSeqNum > userPrefp->initSeqNum) {
    	tmp_popsize = userPrefp->prerunSeqNum;
    }
    else if (userPrefp->prerunSeqNum <= userPrefp->initSeqNum) {
    	tmp_popsize = userPrefp->initSeqNum;
    }
    
    for (curSeq=1; curSeq<= tmp_popsize; curSeq++) {
        ...
        for(curSite = 1; curSite <= userPrefp->seqLen; curSite++)
        {
            ...
            else if (seq_dat[curSeq].site[curSite] == '2')
            {
                ...
                siteData[curSite].freqs2 = tmp_popsize;
                siteData[curSite].freqs0 = 0;
                siteData[curSite].freqs1 = 0;
                siteData[curSite].freqs3 = 0;
            }
            else if (seq_dat[curSeq].site[curSite] == '3')
            {
                ...
                siteData[curSite].freqs3 = tmp_popsize;
                siteData[curSite].freqs0 = 0;
                siteData[curSite].freqs2 = 0;
                siteData[curSite].freqs1 = 0;
            }
            ...
            if (seq_dat[curSeq].site[j] == '0') {
                if (seq_dat[curSeq].site[j+1] == '0') {
                    if (seq_dat[curSeq].site[j+2] == '0') {
                        codon_index=0;
                        wData[curSeq] = wData[curSeq] * cod_w_list[codon_index];
                    }
                ...
                else if (seq_dat[curSeq].site[j+1] == '1') {
                    if (seq_dat[curSeq].site[j+2] == '0') {
                        codon_index=4;
                        wData[curSeq] = wData[curSeq] * cod_w_list[codon_index];
                    }
                ...
                else if (seq_dat[curSeq].site[j+1] == '2') {
                    if (seq_dat[curSeq].site[j+2] == '0') {
                        codon_index=8;
                        wData[curSeq] = wData[curSeq] * cod_w_list[codon_index];
                    }
                ...
                else if (seq_dat[curSeq].site[j+1] == '3') {
                    if (seq_dat[curSeq].site[j+2] == '0') {
                        codon_index=12;
                        wData[curSeq] = wData[curSeq] * cod_w_list[codon_index];
                    }
...
//    fprintf(fpOut, "ave_replacement: %0.4f\n", ave_MCU_replacement);
	fprintf(fpOut, "----------------\n");
	sum01 = sum02 = sum03 = sum10 = sum12 = sum13 = sum20 = sum21 = sum23 = sum30 = sum31 = sum32 = 0;
    
	sum01 += sampleFix01[1] + sampleFix01[2] + sampleFix01[3];
    sum02 += sampleFix02[1] + sampleFix02[2] + sampleFix02[3];
    sum03 += sampleFix03[1] + sampleFix03[2] + sampleFix03[3];
    sum10 += sampleFix10[1] + sampleFix10[2] + sampleFix10[3];
    sum12 += sampleFix12[1] + sampleFix12[2] + sampleFix12[3];
    sum13 += sampleFix13[1] + sampleFix13[2] + sampleFix13[3];
    sum20 += sampleFix20[1] + sampleFix20[2] + sampleFix20[3];
    sum21 += sampleFix21[1] + sampleFix21[2] + sampleFix21[3];
    sum23 += sampleFix23[1] + sampleFix23[2] + sampleFix23[3];
    sum30 += sampleFix30[1] + sampleFix30[2] + sampleFix30[3];
    sum31 += sampleFix31[1] + sampleFix31[2] + sampleFix31[3];
    sum32 += sampleFix32[1] + sampleFix32[2] + sampleFix32[3];
    
	fprintf(fpOut, "sampleFix01        = %lu\n", 		sum01);
    fprintf(fpOut, "sampleFix02        = %lu\n", 		sum02);
    fprintf(fpOut, "sampleFix03        = %lu\n", 		sum03);
    fprintf(fpOut, "sampleFix10        = %lu\n", 		sum10);
    fprintf(fpOut, "sampleFix12        = %lu\n", 		sum12);
    fprintf(fpOut, "sampleFix13        = %lu\n", 		sum13);
    fprintf(fpOut, "sampleFix20        = %lu\n", 		sum20);
    fprintf(fpOut, "sampleFix21        = %lu\n", 		sum21);
    fprintf(fpOut, "sampleFix23        = %lu\n", 		sum23);
    fprintf(fpOut, "sampleFix30        = %lu\n", 		sum30);
    fprintf(fpOut, "sampleFix31        = %lu\n", 		sum31);
	fprintf(fpOut, "sampleFix32        = %lu\n", 		sum32);
    
	fprintf(fpOut, "sampleFix01[1]     = %lu\n", 		sampleFix01[1]	);
	fprintf(fpOut, "sampleFix01[2]     = %lu\n", 		sampleFix01[2]	);
	fprintf(fpOut, "sampleFix01[3]     = %lu\n", 		sampleFix01[3]	);
    fprintf(fpOut, "sampleFix02[1]     = %lu\n", 		sampleFix02[1]	);
    fprintf(fpOut, "sampleFix02[2]     = %lu\n", 		sampleFix02[2]	);
    fprintf(fpOut, "sampleFix02[3]     = %lu\n", 		sampleFix02[3]	);
    fprintf(fpOut, "sampleFix03[1]     = %lu\n", 		sampleFix03[1]	);
    fprintf(fpOut, "sampleFix03[2]     = %lu\n", 		sampleFix03[2]	);
    fprintf(fpOut, "sampleFix03[3]     = %lu\n", 		sampleFix03[3]	);
    fprintf(fpOut, "sampleFix10[1]     = %lu\n", 		sampleFix10[1]	);
    fprintf(fpOut, "sampleFix10[2]     = %lu\n", 		sampleFix10[2]	);
    fprintf(fpOut, "sampleFix10[3]     = %lu\n", 		sampleFix10[3]	);
    fprintf(fpOut, "sampleFix12[1]     = %lu\n", 		sampleFix12[1]	);
    fprintf(fpOut, "sampleFix12[2]     = %lu\n", 		sampleFix12[2]	);
    fprintf(fpOut, "sampleFix12[3]     = %lu\n", 		sampleFix12[3]	);
    fprintf(fpOut, "sampleFix13[1]     = %lu\n", 		sampleFix13[1]	);
    fprintf(fpOut, "sampleFix13[2]     = %lu\n", 		sampleFix13[2]	);
    fprintf(fpOut, "sampleFix13[3]     = %lu\n", 		sampleFix13[3]	);
    fprintf(fpOut, "sampleFix20[1]     = %lu\n", 		sampleFix20[1]	);
    fprintf(fpOut, "sampleFix20[2]     = %lu\n", 		sampleFix20[2]	);
    fprintf(fpOut, "sampleFix20[3]     = %lu\n", 		sampleFix20[3]	);
    fprintf(fpOut, "sampleFix21[1]     = %lu\n", 		sampleFix21[1]	);
    fprintf(fpOut, "sampleFix21[2]     = %lu\n", 		sampleFix21[2]	);
    fprintf(fpOut, "sampleFix21[3]     = %lu\n", 		sampleFix21[3]	);
    fprintf(fpOut, "sampleFix23[1]     = %lu\n", 		sampleFix23[1]	);
    fprintf(fpOut, "sampleFix23[2]     = %lu\n", 		sampleFix23[2]	);
    fprintf(fpOut, "sampleFix23[3]     = %lu\n", 		sampleFix23[3]	);
    fprintf(fpOut, "sampleFix30[1]     = %lu\n", 		sampleFix30[1]	);
    fprintf(fpOut, "sampleFix30[2]     = %lu\n", 		sampleFix30[2]	);
    fprintf(fpOut, "sampleFix30[3]     = %lu\n", 		sampleFix30[3]	);
    fprintf(fpOut, "sampleFix31[1]     = %lu\n", 		sampleFix31[1]	);
    fprintf(fpOut, "sampleFix31[2]     = %lu\n", 		sampleFix31[2]	);
    fprintf(fpOut, "sampleFix31[3]     = %lu\n", 		sampleFix31[3]	);
	fprintf(fpOut, "sampleFix32[1]     = %lu\n", 		sampleFix32[1]	);
	fprintf(fpOut, "sampleFix32[2]     = %lu\n", 		sampleFix32[2]	);
	fprintf(fpOut, "sampleFix32[3]     = %lu\n", 		sampleFix32[3]	);
    
    sum01 = sum02 = sum03 = sum10 = sum12 = sum13 = sum20 = sum21 = sum23 = sum30 = sum31 = sum32 = 0;
    
    sum01 += sampleSeg01[1] + sampleSeg01[2] + sampleSeg01[3];
    sum02 += sampleSeg02[1] + sampleSeg02[2] + sampleSeg02[3];
    sum03 += sampleSeg03[1] + sampleSeg03[2] + sampleSeg03[3];
    sum10 += sampleSeg10[1] + sampleSeg10[2] + sampleSeg10[3];
    sum12 += sampleSeg12[1] + sampleSeg12[2] + sampleSeg12[3];
    sum13 += sampleSeg13[1] + sampleSeg13[2] + sampleSeg13[3];
    sum20 += sampleSeg20[1] + sampleSeg20[2] + sampleSeg20[3];
    sum21 += sampleSeg21[1] + sampleSeg21[2] + sampleSeg21[3];
    sum23 += sampleSeg23[1] + sampleSeg23[2] + sampleSeg23[3];
    sum30 += sampleSeg30[1] + sampleSeg30[2] + sampleSeg30[3];
    sum31 += sampleSeg31[1] + sampleSeg31[2] + sampleSeg31[3];
    sum32 += sampleSeg32[1] + sampleSeg32[2] + sampleSeg32[3];
    
    fprintf(fpOut, "sampleSeg01        = %lu\n", 		sum01);
    fprintf(fpOut, "sampleSeg02        = %lu\n", 		sum02);
    fprintf(fpOut, "sampleSeg03        = %lu\n", 		sum03);
    fprintf(fpOut, "sampleSeg10        = %lu\n", 		sum10);
    fprintf(fpOut, "sampleSeg12        = %lu\n", 		sum12);
    fprintf(fpOut, "sampleSeg13        = %lu\n", 		sum13);
    fprintf(fpOut, "sampleSeg20        = %lu\n", 		sum20);
    fprintf(fpOut, "sampleSeg21        = %lu\n", 		sum21);
    fprintf(fpOut, "sampleSeg23        = %lu\n", 		sum23);
    fprintf(fpOut, "sampleSeg30        = %lu\n", 		sum30);
    fprintf(fpOut, "sampleSeg31        = %lu\n", 		sum31);
    fprintf(fpOut, "sampleSeg32        = %lu\n", 		sum32);
    
    fprintf(fpOut, "sampleSeg01[1]     = %lu\n", 		sampleSeg01[1]	);
    fprintf(fpOut, "sampleSeg01[2]     = %lu\n", 		sampleSeg01[2]	);
    fprintf(fpOut, "sampleSeg01[3]     = %lu\n", 		sampleSeg01[3]	);
    fprintf(fpOut, "sampleSeg02[1]     = %lu\n", 		sampleSeg02[1]	);
    fprintf(fpOut, "sampleSeg02[2]     = %lu\n", 		sampleSeg02[2]	);
    fprintf(fpOut, "sampleSeg02[3]     = %lu\n", 		sampleSeg02[3]	);
    fprintf(fpOut, "sampleSeg03[1]     = %lu\n", 		sampleSeg03[1]	);
    fprintf(fpOut, "sampleSeg03[2]     = %lu\n", 		sampleSeg03[2]	);
    fprintf(fpOut, "sampleSeg03[3]     = %lu\n", 		sampleSeg03[3]	);
    fprintf(fpOut, "sampleSeg10[1]     = %lu\n", 		sampleSeg10[1]	);
    fprintf(fpOut, "sampleSeg10[2]     = %lu\n", 		sampleSeg10[2]	);
    fprintf(fpOut, "sampleSeg10[3]     = %lu\n", 		sampleSeg10[3]	);
    fprintf(fpOut, "sampleSeg12[1]     = %lu\n", 		sampleSeg12[1]	);
    fprintf(fpOut, "sampleSeg12[2]     = %lu\n", 		sampleSeg12[2]	);
    fprintf(fpOut, "sampleSeg12[3]     = %lu\n", 		sampleSeg12[3]	);
    fprintf(fpOut, "sampleSeg13[1]     = %lu\n", 		sampleSeg13[1]	);
    fprintf(fpOut, "sampleSeg13[2]     = %lu\n", 		sampleSeg13[2]	);
    fprintf(fpOut, "sampleSeg13[3]     = %lu\n", 		sampleSeg13[3]	);
    fprintf(fpOut, "sampleSeg20[1]     = %lu\n", 		sampleSeg20[1]	);
    fprintf(fpOut, "sampleSeg20[2]     = %lu\n", 		sampleSeg20[2]	);
    fprintf(fpOut, "sampleSeg20[3]     = %lu\n", 		sampleSeg20[3]	);
    fprintf(fpOut, "sampleSeg21[1]     = %lu\n", 		sampleSeg21[1]	);
    fprintf(fpOut, "sampleSeg21[2]     = %lu\n", 		sampleSeg21[2]	);
    fprintf(fpOut, "sampleSeg21[3]     = %lu\n", 		sampleSeg21[3]	);
    fprintf(fpOut, "sampleSeg23[1]     = %lu\n", 		sampleSeg23[1]	);
    fprintf(fpOut, "sampleSeg23[2]     = %lu\n", 		sampleSeg23[2]	);
    fprintf(fpOut, "sampleSeg23[3]     = %lu\n", 		sampleSeg23[3]	);
    fprintf(fpOut, "sampleSeg30[1]     = %lu\n", 		sampleSeg30[1]	);
    fprintf(fpOut, "sampleSeg30[2]     = %lu\n", 		sampleSeg30[2]	);
    fprintf(fpOut, "sampleSeg30[3]     = %lu\n", 		sampleSeg30[3]	);
    fprintf(fpOut, "sampleSeg31[1]     = %lu\n", 		sampleSeg31[1]	);
    fprintf(fpOut, "sampleSeg31[2]     = %lu\n", 		sampleSeg31[2]	);
    fprintf(fpOut, "sampleSeg31[3]     = %lu\n", 		sampleSeg31[3]	);
    fprintf(fpOut, "sampleSeg32[1]     = %lu\n", 		sampleSeg32[1]	);
    fprintf(fpOut, "sampleSeg32[2]     = %lu\n", 		sampleSeg32[2]	);
    fprintf(fpOut, "sampleSeg32[3]     = %lu\n", 		sampleSeg32[3]	);
    ...
    sum += sampleSeg02[1] + sampleSeg02[2] + sampleSeg02[3];
    sum += sampleSeg03[1] + sampleSeg03[2] + sampleSeg03[3];
    sum += sampleSeg10[1] + sampleSeg10[2] + sampleSeg10[3];
    sum += sampleSeg12[1] + sampleSeg12[2] + sampleSeg12[3];
    sum += sampleSeg13[1] + sampleSeg13[2] + sampleSeg13[3];
    sum += sampleSeg20[1] + sampleSeg20[2] + sampleSeg20[3];
    sum += sampleSeg21[1] + sampleSeg21[2] + sampleSeg21[3];
    sum += sampleSeg23[1] + sampleSeg23[2] + sampleSeg23[3];
    sum += sampleSeg30[1] + sampleSeg30[2] + sampleSeg30[3];
    sum += sampleSeg31[1] + sampleSeg31[2] + sampleSeg31[3];
    sum += sampleSeg32[1] + sampleSeg32[2] + sampleSeg32[3];
    ...
    fprintf(fpOut2, "%lu\t", sampleSeg02[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg02[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg02[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg03[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg03[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg03[3]);
	fprintf(fpOut2, "%lu\t", sampleSeg10[1]);
	fprintf(fpOut2, "%lu\t", sampleSeg10[2]);
	fprintf(fpOut2, "%lu\t", sampleSeg10[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg12[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg12[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg12[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg13[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg13[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg13[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg20[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg20[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg20[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg21[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg21[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg21[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg23[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg23[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg23[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg30[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg30[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg30[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg31[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg31[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg31[3]);
    fprintf(fpOut2, "%lu\t", sampleSeg32[1]);
    fprintf(fpOut2, "%lu\t", sampleSeg32[2]);
    fprintf(fpOut2, "%lu\t", sampleSeg32[3]);
	fprintf(fpOut2, "\n");
    ...
    for(i=1;i<=userPrefp->sampleNum;i++)
    {
        ...
        {
            fprintf(fpOut, "%c", seq_dat[curSeq].site[j]);
        }
        fprintf(fpOut, "\n");
    }
