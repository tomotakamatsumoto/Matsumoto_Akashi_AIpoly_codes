...
c							= 0.020	                	/*	- the recombination rate per site per generation*/
...
Nes						= 1.039	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -97874						/*  - initialize random number generator */
