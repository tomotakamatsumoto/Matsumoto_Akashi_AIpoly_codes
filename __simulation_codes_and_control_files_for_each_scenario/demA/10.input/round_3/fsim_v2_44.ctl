...
repNum						= 10000		                /*	- number of replicates*/
initRunGen					= 50000		            /*	- number of generations for the initial run*/
preRunGen					= 5000		            	/*	- number of generations for the prerun between replicates*/
...
c							= 0.0000001800	                	/*	- the recombination rate per site per generation*/
...
Nes2						= 0.0	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -7846476						/*  - initialize random number generator */
