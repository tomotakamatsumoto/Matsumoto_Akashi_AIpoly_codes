...
u01							= 0.0000250	            	/*		- the 0 to 1 mutation rate per site per generation*/
Nes						    = 1.121	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -436211						/*  - initialize random number generator */
