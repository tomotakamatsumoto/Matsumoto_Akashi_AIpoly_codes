...
initSeqNum					= 2000		                /*	- number of sequences at the start of the simulation. if there is no population fluctuation the population remains at this size*/
...
c							= 0.0005	                	/*	- the recombination rate per site per generation*/
u10							= 0.000005	            	/*		- the 1 to 0 mutation rate per site per generation*/
u01							= 0.000005	            	/*		- the 0 to 1 mutation rate per site per generation*/
Nes						= 0.202	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -9094						/*  - initialize random number generator */
