...
uswitch_A					= 7130		            	/*	- number of generations after which mutation rates switch to "b" type*/
...
SeqNum_a					= 10000		                /*	- number of sequences at the start of the simulation. if there is no population fluctuation the population remains at this size*/
SeqNum_b					= 10000		                /*	- number of sequences at the start of the simulation. if there is no population fluctuation the population remains at this size*/
seqLen						= 100000		            	/*	- length of sequences. has to be a multiple of 3*/
sampleNum					= 10000		                /*	- number of sequences to be sampled from the population every replicate*/
