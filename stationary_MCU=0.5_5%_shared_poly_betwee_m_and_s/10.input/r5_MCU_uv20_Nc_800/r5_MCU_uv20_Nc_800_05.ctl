...
c							= 0.000007	                	/*	- the recombination rate per site per generation*/
u10							= 0.0000250	            	/*		- the 1 to 0 mutation rate per site per generation*/
u01							= 0.0000125	            	/*		- the 0 to 1 mutation rate per site per generation*/
Nes						= 1.814	                    /* 2Nes - selection parameter for MCU model */
idum_init					= -1136211						/*  - initialize random number generator */
